"""Training Script for Phase F Cancer Risk (UCI Breast Cancer Wisconsin) Baseline Models."""
import json
import os
import sys
...
logger = get_logger("train_cancer")
...
def train_and_evaluate_cancer_models():
    """Trains Logistic Regression and Random Forest on UCI Breast Cancer dataset and saves artifacts."""
    if not DATASET_PATH.exists():
        raise FileNotFoundError(f"Cancer dataset missing at {DATASET_PATH}")

    logger.info(f"Loading cancer dataset from '{DATASET_PATH}'...")
    ...
    models_config = [
        {
            ...
            "model_name": "Breast Cancer Logistic Regression",
        ...
        },
        {
            ...
            "model_name": "Breast Cancer Random Forest",
            "model_family": "classical",
    ...
    for cfg in models_config:
        ...
        artifact = ModelArtifact(
            ...
            dataset_provenance={
                ...
                "hash": "4a72d3e11f84b65c2e5b7218691a305988e09f584e03d4021303ec5d5e56d78a",
            },
...
if __name__ == "__main__":
    train_and_evaluate_cancer_models()
